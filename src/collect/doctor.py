...
_CORE_MODULES = [
    ...
    "collect.retrieval.filecontext",
    "collect.agents.filecontext",
    # Agenten-Schicht (Phase 3)
    "collect.bus",
    "collect.agents.runner",
    "collect.client",
    "collect.api_security",
    ...
    "collect.qwythos.tools",
    "collect.agents.qwythos",
    "collect.traces.schema",
    "collect.traces.collector",
    "collect.traces.validate",
    "collect.traces.curate",
    "collect.traces.cli",
    "collect.prompts",
    "collect.patterns",
    "collect.eval",
